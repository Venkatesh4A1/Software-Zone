$(document).ready(function(){
	...
	if(location=="http://localhost:8080/Automobiles/" || location=="http://localhost:8080/Automobiles/home"){
		$('a[href*="/home"] .on').css('color','white');
	}
	if(location=="http://localhost:8080/Automobiles/login?logout"){
		$('a[href*="/login"] .on').css('color','white');
	}
	if(location=="http://localhost:8080/Automobiles/all/product/getallproducts"){
		$('a[href*="/getallproducts"] .on').css('color','white');
	}
	if(location=="http://localhost:8080/Automobiles/admin/product/productform"){
